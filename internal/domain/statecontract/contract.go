	...
	return Contract{
		...
		Fields: []Field{
			...
			{Path: "issues[].publication_audit", Class: Optional, Introduced: 1,
				Migration: MigrationPolicy{Code: "OPTIONAL_NO_MIGRATION", Kind: "compatible"}},
			{Path: "issues[].github_state_reason", Class: Optional, Introduced: 4,
				Migration: MigrationPolicy{Code: "OPTIONAL_GITHUB_OBSERVATION", Kind: "compatible"}},
			{Path: "issues[].cancellation", Class: Optional, Introduced: 4,
				Migration: MigrationPolicy{Code: "OPTIONAL_CANCELLATION_EVIDENCE", Kind: "compatible"}},
