...
printf '%s\n' "$version_json" | grep -Fq '"state_schema_current":6'
printf '%s\n' "$version_json" | grep -Fq '"state_schema_migration_from":5'
printf '%s\n' "$version_json" | grep -Fq '"semantic_contract_current":6'
...
grep -Fq '"state_schema_current": 6' "$temporary_root/first/release-manifest.json"
grep -Fq '"state_schema_migration_from": 5' "$temporary_root/first/release-manifest.json"
grep -Fq '"semantic_contract_current": 6' "$temporary_root/first/release-manifest.json"
...
grep -Fq '"semantic_contract_minimum": 6' "$temporary_root/first/release-manifest.json"
